...
$compute_js =<<<JS
        $('#w0').on('change',function() {
            ...
            gross_profit_amz = (no_rebate_amount-costprice+(bill_rebate_amount)-(ams_logistics_fee*$exchange_rate)-amz_transaction_fee*$exchange_rate*$exchange_rate).toFixed(3) ;
