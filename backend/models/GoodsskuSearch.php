...
class GoodsskuSearch extends Goodssku
{
    ...
    public function rules()
    {
        return [
            ...
            [[ 'pd_title','pd_title_en','image_url','sku', 'currency_code', 'old_sku', 'sale_company', 'vendor_code', 'origin_code', 'pd_costprice_code', 'bill_name', 'bill_unit', 'brand', 'sku_mark'], 'safe'],
