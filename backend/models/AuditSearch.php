...
class AuditSearch extends PurInfo
{
    ...
    public function rules()
    {
        return [
            ...
            [['pd_create_time','view_status','preview_status','member','purchaser', 'pd_title', 'pd_title_en', 'pd_pic_url', 'pd_package', 'pd_length', 'pd_width', 'pd_height', 'pd_material', 'bill_type', 'bill_rebate_amount',
