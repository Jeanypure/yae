...
class YaeSupplierSearch extends YaeSupplier
{
    ...
    public function rules()
    {
        return [
            ...
            [['credit_code','create_date','check_memo','checker','supplier_code', 'supplier_name', 'pd_bill_name', 'bill_unit', 'submitter', 'business_licence', 'bank_account_data', 'pay_card', 'pay_name', 'pay_bank', 'sup_remark', 'account_proportion', 'bill_img1', 'bill_img1_name_unit', 'bill_img2', 'bill_img2_name_unit', 'complete_num', 'supplier_address'], 'safe'],
        ];
    }
