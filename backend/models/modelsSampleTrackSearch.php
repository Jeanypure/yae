...
/**
 * modelsSampleTrackSearch represents the model behind the search form of `backend\models\SampleTrack`.
 */
class modelsSampleTrackSearch extends SampleTrack
{
    /**
     * {@inheritdoc}
     */
