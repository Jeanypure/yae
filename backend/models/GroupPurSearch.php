...
class GroupPurSearch extends PurInfo
{
    ...
    public function rules()
    {
        return [
            ...
            [['purchaser', 'pd_title', 'pd_title_en', 'pd_pic_url', 'pd_package', 'pd_length', 'pd_width', 'pd_height', 'pd_material', 'bill_type', 'bill_rebate_amount', 'no_rebate_amount', 'retail_price', 'ebay_url', 'amazon_url', 'url_1688', 'shipping_fee', 'oversea_shipping_fee', 'transaction_fee', 'gross_profit', 'remark', 'source', 'member', 'accept_status_pur'], 'safe'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'purchaser', $this->purchaser])
            ...
            ->andFilterWhere(['like', 'accept_status_pur', $this->accept_status_pur]);
